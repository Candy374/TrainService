...
export const Section = ({checkbox, checked, title, children, list, className, onChange }) => {
    ...
    return (
        <div className={classes.join(' ')}>
            {checkbox && <input type='checkbox' onChange={onChange} value={checked} checked={checked} />}
            {title && 
                <div className='head'>
